...
void CMatrix::setVector(int val)
{
	for (int i = 0; i < n_rows; i++)
	{
...
void CMatrix::setMatrixCol(int col, int size, ...)
{
	int m_size = size;
	int* marker = &size;
	marker++;
...
void CMatrix::setMatrixRow(int row, int size, ...)
{
	int m_size = size;
	int* marker = &size;
	marker++;
...
void CMatrix::setMatrixElem(int row,int col,double val)
{
	array[row][col] = val;
}
